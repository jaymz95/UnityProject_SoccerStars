...
public class ScrollingBackground : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        layers = new Transform[transform.childCount]; // childCount = 3 background children
    ...
    void Update()
    {
        float delatX =  cameraTransform.position.x - lastCameraX;
        transform.position += Vector3.right * (delatX * paralaxSpeed);
        lastCameraX = cameraTransform.position.x;
